-- Write down stored procedure to accept input values as a parameter and update values of the tables.
...
-- procedure to update marks of all students of a course
create or replace procedure update_marks_by_course(
    p_course VARCHAR(50),
    p_marks INT
)
LANGUAGE plpgsql
...
CALL update_marks_by_course('MCA', 60);
